...
const MapWithPolygons = () => {
  ...
  return (
    <SafeAreaView style={{ flex: 1 ,backgroundColor:'transparent'}}>
                            {/* <Text style={{color:'black'}}>{back ? JSON.stringify(back) : ''}</Text> */}
            ...
            {/* <TouchableOpacity onPress={() => navigation.navigate('Planeroute', { locationforroute:currentLocation })} style={{backgroundColor:'#20b2aa',width:100,marginLeft:140,borderRadius:40}}><Text style={{color:'black',alignSelf:'center',height:40,fontSize:20,fontWeight:'bold'}}>Plane Route</Text></TouchableOpacity> */}
        </SafeAreaView>
    );
};
